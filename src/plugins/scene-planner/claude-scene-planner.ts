...
1. "real_photo" — Photorealistic AI image of a SPECIFIC real thing.
   The AI will generate a realistic-looking depiction.
   ...
   DESCRIPTION: Write a detailed visual description (20-40 words) of exactly
   what the image should show. Include setting, lighting, perspective.
...
2. "ai_illustration" — Stylized cartoon/concept art illustration.
   ...
   DESCRIPTION: Describe the SCENE (20-40 words), include lighting, style, and mood.
   Example: "A glowing translucent human brain with neural pathways lighting up in electric blue, surrounded by floating mathematical equations, dark purple background"
...
4. "diagram" — Clean SVG diagram (auto-generated by Claude).
